...
btn.addEventListener("click", async function () {
  ...
  // console.log(await myQuiz.getAllQuestions());
...
class Question {
  ...
  display() {
    const questionMarkUp = `
        <div class="question shadow-lg col-lg-8 offset-lg-2 p-4 rounded-3 d-flex flex-column justify-content-center align-items-center gap-3 animate__animated animate__bounceIn" >
          <div class="w-100 d-flex justify-content-between">
            <span class="btn btn-category">${this.category}</span>
            <span class="fs-6 btn btn-questions"> ${this.index + 1} of ${questions.length}</span></div>
        ...
        .replaceAll(",", "")}
          ...
          <h2 class="text-capitalize text-center score-color h3 fw-bold"><i class="bi bi-emoji-laughing"></i>
           Score: ${myQuiz.score} 
      </h2>
      </div>
      `;
